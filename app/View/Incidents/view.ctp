...
<div class="container">
  <div class="row">
    <div class="col-sm">
      <?php echo $this->Html->link(__('Editar'), array('controller' => 'Incidents', 'action' => 'edit'.'/'.$incident['Incident']['id']), array('type'=>'button','class' => 'btn mbtn btn-warning')); ?> 
    </div>
	<div class="col-sm">
    </div>
    <div class="col-sm">
      <?php echo $this->Html->link(__('Terminar'), array('controller' => 'Routes', 'action' => 'scan'), array('type'=>'button','class' => 'btn mbtn btn-success')); ?> 
    </div>
  </div>
</div>
