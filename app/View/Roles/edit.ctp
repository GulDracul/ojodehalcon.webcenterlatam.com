...
<?php echo $this->Form->create('Role'); ?>
	<fieldset>
		<legend><?php echo __('Editar rol a conjunto'); ?></legend>
	<?php
		...
		echo $this->Form->input('complex_id',array('label'=>'Conjunto', 'placeholder' => '', 'class' => 'form-control selectpicker','data-live-search'=>'true'));
	?>
	</fieldset>
<?php echo $this->Form->end(__('Editar rol')); ?>
</div>
<div class="actions">
