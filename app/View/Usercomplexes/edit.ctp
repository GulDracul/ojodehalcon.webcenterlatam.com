...
<?php echo $this->Form->create('Usercomplex'); ?>
	<fieldset>
		<legend><?php echo __('Edit Usercomplex'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Usercomplex.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Usercomplex.id')))); ?></li>
